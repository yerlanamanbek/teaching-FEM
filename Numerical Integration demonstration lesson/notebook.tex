...
The integral can be viewed graphically as the area between the x-axis
and the curve y = f (x) in the region of the limits of integration.
Thus, we can interpret numerical integration as an approximation of that
area.
...
{\color{incolor}In [{\color{incolor}3}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Do not change the text in this box}
        ...
        \PY{n}{n\PYZus{}slider} \PY{o}{=} \PY{n}{widgets}\PY{o}{.}\PY{n}{IntSlider}\PY{p}{(}\PY{n+nb}{min}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,}\PY{n+nb}{max}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{step}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{value}\PY{o}{=}\PY{l+m+mi}{4}\PY{p}{,} \PY{n}{description}\PY{o}{=}\PY{l+s+sa}{r}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}n\PYZus{}}\PY{l+s+si}{\PYZob{}start\PYZcb{}}\PY{l+s+s1}{\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} Do not change the text in this box}
        \PY{c+c1}{\PYZsh{} \PYZhy{}3*x**2+2*x+6}
        \PY{n}{f\PYZus{}box} \PY{o}{=} \PY{n}{Text}\PY{p}{(}\PY{n}{value}\PY{o}{=}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{exp(\PYZhy{}x**2)}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{description}\PY{o}{=}\PY{l+s+sa}{r}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}f(x)=\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
        \PY{n}{n\PYZus{}slider} \PY{o}{=} \PY{n}{widgets}\PY{o}{.}\PY{n}{IntSlider}\PY{p}{(}\PY{n+nb}{min}\PY{o}{=}\PY{l+m+mi}{1}\PY{p}{,}\PY{n+nb}{max}\PY{o}{=}\PY{l+m+mi}{20}\PY{p}{,} \PY{n}{step}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{value}\PY{o}{=}\PY{l+m+mi}{2}\PY{p}{,} \PY{n}{description}\PY{o}{=}\PY{l+s+sa}{r}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZdl{}n\PYZus{}}\PY{l+s+si}{\PYZob{}start\PYZcb{}}\PY{l+s+s1}{\PYZdl{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
4\strut
\end{minipage} & \begin{minipage}[t]{0.34\columnwidth}\centering\strut
\(\frac{18+\sqrt{30}}{36}\)\strut
\end{minipage} & \begin{minipage}[t]{0.44\columnwidth}\centering\strut
\(\pm \sqrt {\frac{3}{7} -\frac{2}{7} \sqrt{\frac{6}{5}}}\)\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.13\columnwidth}\centering\strut
\strut
\end{minipage} & \begin{minipage}[t]{0.34\columnwidth}\centering\strut
...
\(\int_{-1}^1 \left( x^2+\cos{x} \right)\,dx \approx f \left( \frac{-\sqrt 3}{3}\right)+ f \left( \frac{\sqrt 3}{3}\right)\)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:} \PY{k+kn}{from} \PY{n+nn}{scipy}\PY{n+nn}{.}\PY{n+nn}{integrate} \PY{k}{import} \PY{n}{quad}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{n}{I\PYZus{}actual} \PY{o}{=}\PY{l+m+mi}{2}\PY{o}{/}\PY{l+m+mi}{3} \PY{o}{+} \PY{l+m+mi}{2}\PY{o}{*}\PY{n}{sin}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)} \PY{c+c1}{\PYZsh{}computed integral}
...
Trapezoidal rule computation of integral is 3.0806046117 and error is 0.7309959755
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{\PYZsh{}Gauss quadrature rule for integral computation}
